...
int x_kernel(Mat initialImage,int x[][3],int y[][3],int i,int j){
  int xValOfPixel =
...
int y_kernel(Mat initialImage,int x[][3],int y[][3],int i,int j){
  int yValOfPixel =
          (y[0][0] * (int)initialImage.at<uchar>(j, i)) + (y[0][1] * (int)initialImage.at<uchar>(j + 1, i)) + (y[0][2] * (int)initialImage.at<uchar>(j + 2, i)) +
